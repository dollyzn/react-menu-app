    ...
    <AlertDialog open={isSessionExpired} onOpenChange={() => {}}>
      <AlertDialogContent className="max-w-md p-0">
        <AlertDialogHeader className="gap-0">
          <AlertDialogTitle className="text-2xl px-6 py-5 text-start">
            Sessão Expirada
          </AlertDialogTitle>
          <AlertDialogDescription className="border-t border-b p-6 flex flex-col sm:flex-row items-center gap-2 sm:gap-6">
